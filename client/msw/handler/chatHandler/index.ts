...
export const chatHandler = [rest.post(POST_IMAGE_API_URL, postImageHandler), rest.post(POST_CHAT_READ_API_URL, postChatReadHandler), rest.post(POST_CHAT_API_URL, postChatHandler), rest.post(JOIN_CHAT_URL, joinChatHandler), rest.post(CHAT_INFO_URL, chatInfoHandler), rest.get(CHAT_MESSAGES_API_URL, chatMessagesHandler)];
