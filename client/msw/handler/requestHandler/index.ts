...
export const request = [rest.post(ACCEPT_API_URL, acceptHandler), rest.post(DENY_API_URL, denyHandler), rest.post(REQUEST_API_URL, requestApiHandler), rest.post(REQUEST_URL, requestHandler)];
